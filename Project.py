...
pliz = df.plot.bar(title='December Snowfall in Central Park by Season', fontsize=20, legend = False, width = .95, figsize = (50,6), color = colors)
pliz.title.set_size(40)
pliz.set_xlabel("Season", fontsize=30)
pliz.set_ylabel("Inches of Snowfall", fontsize=30)
HA = mpatches.Patch(color='m', label='Traces of Hail')
pliz.legend(handles=[HA],prop={'size':25}, loc=2)
plt.show()
